...
public class Reptiles extends Animal implements Animal_interface {
    ...
    public Reptiles(String new_animal_ID,String new_animal_name,String new_animal_type,String new_animal_description,String new_animal_sound){
